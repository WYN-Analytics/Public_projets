...
/*
Cette requête identifie les écarts entre les montants totaux des commandes et les paiements reçus.
Elle retourne les commandes où le montant total (total_ttc) ne correspond pas à la somme des paiements,
permettant de détecter les problèmes de paiement ou les transactions incomplètes.
*/
------------------------------------------------------------
